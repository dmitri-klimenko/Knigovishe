...
namespace Knigosha.Persistence.Migrations
{
    ...
    [Migration("20190829050538_ChangesInActivationKey")]
    partial class ChangesInActivationKey
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Knigosha.Core.Models.ActivationKey", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("ActivationKey");
                });
            ...
            modelBuilder.Entity("Knigosha.Core.Models.UserSubscription", b =>
                {
                    ...
                    b.Property<int?>("ClassActivationKeyId");

                    b.Property<int?>("FamilyActivationKeyId");
                    ...
                    b.Property<int?>("StudentActivationKeyId");
                    ...
                    b.HasIndex("ClassActivationKeyId");

                    b.HasIndex("FamilyActivationKeyId");

                    b.HasIndex("StudentActivationKeyId");
            ...
            modelBuilder.Entity("Knigosha.Core.Models.ClassActivationKey", b =>
                {
                    b.HasBaseType("Knigosha.Core.Models.ActivationKey");

                    b.HasDiscriminator().HasValue("ClassActivationKey");
                });

            modelBuilder.Entity("Knigosha.Core.Models.FamilyActivationKey", b =>
                {
                    b.HasBaseType("Knigosha.Core.Models.ActivationKey");

                    b.HasDiscriminator().HasValue("FamilyActivationKey");
                });

            modelBuilder.Entity("Knigosha.Core.Models.StudentActivationKey", b =>
                {
                    b.HasBaseType("Knigosha.Core.Models.ActivationKey");
                    ...
                    b.HasDiscriminator().HasValue("StudentActivationKey");
                });
            ...
            modelBuilder.Entity("Knigosha.Core.Models.UserSubscription", b =>
                {
                    b.HasOne("Knigosha.Core.Models.ClassActivationKey", "ClassActivationKey")
                        .WithMany()
                        .HasForeignKey("ClassActivationKeyId");

                    b.HasOne("Knigosha.Core.Models.FamilyActivationKey", "FamilyActivationKey")
                        .WithMany()
                        .HasForeignKey("FamilyActivationKeyId");

                    b.HasOne("Knigosha.Core.Models.StudentActivationKey", "StudentActivationKey")
                        .WithMany()
                        .HasForeignKey("StudentActivationKeyId");
            ...
            modelBuilder.Entity("Knigosha.Core.Models.StudentActivationKey", b =>
                {
                    b.HasOne("Knigosha.Core.Models.UserSubscription")
                        .WithMany("StudentActivationKeys")
