...
namespace Knigosha.Core.Models
{
    ...
    public class Question
    {
        ...
        [RequiredIf("QuestionType == 1", ErrorMessage = "Пожалуйста, введите правильный ответ")]
        [Display(Name = "Правильный ответ:")]
        public string RightAnswer { get; set; }


        [RequiredIf("QuestionType == 1", ErrorMessage = "Пожалуйста, введите первый неправильный ответ")]
        [Display(Name = "Первый неправильный ответ:")]
        public string WrongAnswer1 { get; set; }


        [RequiredIf("QuestionType == 1", ErrorMessage = "Пожалуйста, введите второй неправильный ответ")]
